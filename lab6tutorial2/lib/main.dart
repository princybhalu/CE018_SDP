...
void main() => runApp(MaterialApp(
  ...
  // Scaffold is widgets built in flutter sdk..Scaffold is one type o layout manager..
  home: Scaffold(
    appBar: AppBar(
    ...
    body: Center(
      child: Text('Hello Our Name Is Megha And Princy.',
        style: TextStyle(
          fontSize: 24.0,
    ...
    floatingActionButton: FloatingActionButton(
      //Compulsory onPressed after floatingActionButton
      onPressed: () { },
