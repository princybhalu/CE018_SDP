...
void main(List<String> arguments) {
  ...
  */
  ...
  /* ChecPambhar the type at runtime
  ...
  */
  ...
  /* 
    ...
    const name = 'Akash';
    message += name;    // 'Hello my name is Akash'
    ...
    message.write('Akash');
    message.toString();   // "Hello my name is Akash"
  ...
  */
  ...
  /* Interpolation
    ...
    const name = 'Akash';
    const introduction = 'Hello my name is $name';    // 'Hello my name is Akash'
  ...
  */
  ...
  /* Mini-exercises
    ...
    3)
      const firstName = "Akash";
      const lastName = "Pambhar";
      const myDetails = "Hello, my name is $firstName $lastName."; //Hello, my name is Akash Pambhar.
  */
